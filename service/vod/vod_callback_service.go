...
func (p *Vod) AddCallbackSubscription(req *request.VodAddCallbackSubscriptionRequest) (*response.VodAddCallbackSubscriptionResponse, int, error) {
	...
	respBody, status, err := p.Query("AddCallbackSubscription", query)

	output := &response.VodAddCallbackSubscriptionResponse{}
...
func (p *Vod) SetCallbackEvent(req *request.VodSetCallbackEventRequest) (*response.VodSetCallbackEventResponse, int, error) {
	...
	respBody, status, err := p.Query("SetCallbackEvent", query)

	output := &response.VodSetCallbackEventResponse{}
	unmarshaler := protojson.UnmarshalOptions{
		DiscardUnknown: true,
	}
	errUnmarshal := unmarshaler.Unmarshal(respBody, output)
