 ...
 * @return *response.DescribeVodRealtimeMediaDataResponse, int, error
 */
func (p *Vod) DescribeVodRealtimeMediaData(req *request.DescribeVodRealtimeMediaDataRequest) (*response.DescribeVodRealtimeMediaDataResponse, int, error) {
	query := url.Values{}
	form := url.Values{}
	marshaler := protojson.MarshalOptions{
		Multiline:       false,
	...
	respBody, status, err := p.Query("DescribeVodRealtimeMediaData", query)

	output := &response.DescribeVodRealtimeMediaDataResponse{}
	unmarshaler := protojson.UnmarshalOptions{
		DiscardUnknown: true,
	}
	errUnmarshal := unmarshaler.Unmarshal(respBody, output)
