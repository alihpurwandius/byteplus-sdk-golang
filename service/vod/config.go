...
func NewInstanceWithRegion(region string) *Vod {
	...
	if apiInfoList, ok = ApiInfoListMap[region]; !ok {
		panic("Cant find the region, please check it carefully")
	}
...
var (
	...
	ApiInfoListMap = map[string]map[string]*base.ApiInfo{
		base.RegionApSingapore:  ApiInfoList,
		base.RegionApSouthEast1: ApiInfoListApSoutheast1,
	}
	...
	ApiInfoListApSoutheast1 = map[string]*base.ApiInfo{
		// **********************************************************************
		// 播放
		// **********************************************************************
		"GetPlayInfo": {
