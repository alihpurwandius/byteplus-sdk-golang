 ...
 * @return *response.VodCreatePlaylistResponse, int, error
 */
func (p *Vod) CreatePlaylist(req *request.VodCreatePlaylistRequest) (*response.VodCreatePlaylistResponse, int, error) {
	query := url.Values{}
	form := url.Values{}
	marshaler := protojson.MarshalOptions{
		Multiline:       false,
	...
	respBody, status, err := p.Query("CreatePlaylist", query)

	output := &response.VodCreatePlaylistResponse{}
	unmarshaler := protojson.UnmarshalOptions{
		DiscardUnknown: true,
	}
	errUnmarshal := unmarshaler.Unmarshal(respBody, output)
 ...
 * @return *response.VodGetPlaylistsResponse, int, error
 */
func (p *Vod) GetPlaylists(req *request.VodGetPlaylistsRequest) (*response.VodGetPlaylistsResponse, int, error) {
	query := url.Values{}
	form := url.Values{}
	marshaler := protojson.MarshalOptions{
		Multiline:       false,
	...
	respBody, status, err := p.Query("GetPlaylists", query)

	output := &response.VodGetPlaylistsResponse{}
	unmarshaler := protojson.UnmarshalOptions{
		DiscardUnknown: true,
	}
	errUnmarshal := unmarshaler.Unmarshal(respBody, output)
 ...
 * @return *response.VodUpdatePlaylistResponse, int, error
 */
func (p *Vod) UpdatePlaylist(req *request.VodUpdatePlaylistRequest) (*response.VodUpdatePlaylistResponse, int, error) {
	query := url.Values{}
	form := url.Values{}
	marshaler := protojson.MarshalOptions{
		Multiline:       false,
	...
	respBody, status, err := p.Query("UpdatePlaylist", query)

	output := &response.VodUpdatePlaylistResponse{}
	unmarshaler := protojson.UnmarshalOptions{
		DiscardUnknown: true,
	}
	errUnmarshal := unmarshaler.Unmarshal(respBody, output)
 ...
 * @return *response.VodDeletePlaylistResponse, int, error
 */
func (p *Vod) DeletePlaylist(req *request.VodDeletePlaylistRequest) (*response.VodDeletePlaylistResponse, int, error) {
	query := url.Values{}
	form := url.Values{}
	marshaler := protojson.MarshalOptions{
		Multiline:       false,
	...
	respBody, status, err := p.Query("DeletePlaylist", query)

	output := &response.VodDeletePlaylistResponse{}
	unmarshaler := protojson.UnmarshalOptions{
		DiscardUnknown: true,
	}
	errUnmarshal := unmarshaler.Unmarshal(respBody, output)
