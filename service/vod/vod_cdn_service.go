 ...
 */
func (p *Vod) UpdateDomainPlayRule(req *request.VodUpdateDomainPlayRuleRequestRequest) (*response.VodUpdateDomainPlayRuleResponse, int, error) {
	query := url.Values{}
	form := url.Values{}
	marshaler := protojson.MarshalOptions{
		Multiline:       false,
 ...
 * @return *response.VodListCdnUsageDataDetailResponse, int, error
 */
func (p *Vod) ListCdnUsageDataDetail(req *request.VodListCdnUsageDataDetailRequest) (*response.VodListCdnUsageDataDetailResponse, int, error) {
	query := url.Values{}
	form := url.Values{}
	marshaler := protojson.MarshalOptions{
		Multiline:       false,
	...
	respBody, status, err := p.Query("ListCdnUsageDataDetail", query)

	output := &response.VodListCdnUsageDataDetailResponse{}
	unmarshaler := protojson.UnmarshalOptions{
		DiscardUnknown: true,
	}
	errUnmarshal := unmarshaler.Unmarshal(respBody, output)
 ...
 * @return *response.VodListCdnStatusDataDetailResponse, int, error
 */
func (p *Vod) ListCdnStatusDataDetail(req *request.VodListCdnStatusDataDetailRequest) (*response.VodListCdnStatusDataDetailResponse, int, error) {
	query := url.Values{}
	form := url.Values{}
	marshaler := protojson.MarshalOptions{
		Multiline:       false,
	...
	respBody, status, err := p.Query("ListCdnStatusDataDetail", query)

	output := &response.VodListCdnStatusDataDetailResponse{}
	unmarshaler := protojson.UnmarshalOptions{
		DiscardUnknown: true,
	}
	errUnmarshal := unmarshaler.Unmarshal(respBody, output)
