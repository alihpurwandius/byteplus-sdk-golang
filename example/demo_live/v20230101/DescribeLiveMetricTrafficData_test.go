...
func Test_DescribeLiveMetricTrafficData(t *testing.T) {
	...
	param := &live_v20230101.DescribeLiveMetricTrafficDataBody{}

	resp, err := instance.DescribeLiveMetricTrafficData(param)
