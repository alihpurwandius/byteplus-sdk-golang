...
func Test_DescribeLivePushStreamInfoData(t *testing.T) {
	...
	param := &live_v20230101.DescribeLivePushStreamInfoDataBody{}

	resp, err := instance.DescribeLivePushStreamInfoData(param)
