...
func Test_DescribeLiveStreamSessionData(t *testing.T) {
	...
	param := &live_v20230101.DescribeLiveStreamSessionDataBody{}

	resp, err := instance.DescribeLiveStreamSessionData(param)
