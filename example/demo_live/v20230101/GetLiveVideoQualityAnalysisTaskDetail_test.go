...
func Test_GetLiveVideoQualityAnalysisTaskDetail(t *testing.T) {
	...
	param := &live_v20230101.GetLiveVideoQualityAnalysisTaskDetailBody{}

	resp, err := instance.GetLiveVideoQualityAnalysisTaskDetail(param)
