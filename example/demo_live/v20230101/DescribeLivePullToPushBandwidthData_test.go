...
func Test_DescribeLivePullToPushBandwidthData(t *testing.T) {
	...
	param := &live_v20230101.DescribeLivePullToPushBandwidthDataBody{}

	resp, err := instance.DescribeLivePullToPushBandwidthData(param)
