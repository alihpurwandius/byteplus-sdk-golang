...
func Test_DescribeLiveBatchPushStreamMetrics(t *testing.T) {
	...
	param := &live_v20230101.DescribeLiveBatchPushStreamMetricsBody{}

	resp, err := instance.DescribeLiveBatchPushStreamMetrics(param)
