...
func Test_CreateLiveVideoQualityAnalysisTask(t *testing.T) {
	...
	param := &live_v20230101.CreateLiveVideoQualityAnalysisTaskBody{}

	resp, err := instance.CreateLiveVideoQualityAnalysisTask(param)
