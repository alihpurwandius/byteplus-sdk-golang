...
func Test_CreateSubtitleTranscodePreset(t *testing.T) {
	...
	param := &live_v20230101.CreateSubtitleTranscodePresetBody{}

	resp, err := instance.CreateSubtitleTranscodePreset(param)
