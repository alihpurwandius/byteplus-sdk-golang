...
func Test_DescribeLiveASRDurationData(t *testing.T) {
	...
	param := &live_v20230101.DescribeLiveASRDurationDataBody{}

	resp, err := instance.DescribeLiveASRDurationData(param)
