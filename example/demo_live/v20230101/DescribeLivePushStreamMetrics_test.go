...
func Test_DescribeLivePushStreamMetrics(t *testing.T) {
	...
	param := &live_v20230101.DescribeLivePushStreamMetricsBody{}

	resp, err := instance.DescribeLivePushStreamMetrics(param)
