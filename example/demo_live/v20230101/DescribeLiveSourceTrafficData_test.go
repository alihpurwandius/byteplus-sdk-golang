...
func Test_DescribeLiveSourceTrafficData(t *testing.T) {
	...
	param := &live_v20230101.DescribeLiveSourceTrafficDataBody{}

	resp, err := instance.DescribeLiveSourceTrafficData(param)
