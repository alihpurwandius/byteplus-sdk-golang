...
func Test_ListVhostSubtitleTranscodePreset(t *testing.T) {
	...
	param := &live_v20230101.ListVhostSubtitleTranscodePresetBody{}

	resp, err := instance.ListVhostSubtitleTranscodePreset(param)
