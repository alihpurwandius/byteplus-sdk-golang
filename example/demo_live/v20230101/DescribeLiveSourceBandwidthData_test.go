...
func Test_DescribeLiveSourceBandwidthData(t *testing.T) {
	...
	param := &live_v20230101.DescribeLiveSourceBandwidthDataBody{}

	resp, err := instance.DescribeLiveSourceBandwidthData(param)
