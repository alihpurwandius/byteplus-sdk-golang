...
func Test_DescribeLiveTranscodeInfoData(t *testing.T) {
	...
	param := &live_v20230101.DescribeLiveTranscodeInfoDataBody{}

	resp, err := instance.DescribeLiveTranscodeInfoData(param)
