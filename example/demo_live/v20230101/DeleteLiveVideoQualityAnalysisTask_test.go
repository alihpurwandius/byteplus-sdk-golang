...
func Test_DeleteLiveVideoQualityAnalysisTask(t *testing.T) {
	...
	param := &live_v20230101.DeleteLiveVideoQualityAnalysisTaskBody{}

	resp, err := instance.DeleteLiveVideoQualityAnalysisTask(param)
