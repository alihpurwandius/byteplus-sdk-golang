...
func Test_DescribeLivePlayStatusCodeData(t *testing.T) {
	...
	param := &live_v20230101.DescribeLivePlayStatusCodeDataBody{}

	resp, err := instance.DescribeLivePlayStatusCodeData(param)
