...
func Test_DescribeUserAgentAccessRule(t *testing.T) {
	...
	param := &live_v20230101.DescribeUserAgentAccessRuleBody{}

	resp, err := instance.DescribeUserAgentAccessRule(param)
