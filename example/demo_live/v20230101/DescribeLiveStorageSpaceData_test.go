...
func Test_DescribeLiveStorageSpaceData(t *testing.T) {
	...
	param := &live_v20230101.DescribeLiveStorageSpaceDataBody{}

	resp, err := instance.DescribeLiveStorageSpaceData(param)
