...
func Test_DescribeLiveP95PeakBandwidthData(t *testing.T) {
	...
	param := &live_v20230101.DescribeLiveP95PeakBandwidthDataBody{}

	resp, err := instance.DescribeLiveP95PeakBandwidthData(param)
